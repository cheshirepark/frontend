    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          {/* VERTICAL TEXT */}
          <span
            className="hidden sm:block text-mining-gold text-[10px] uppercase tracking-[0.4em] font-sans font-bold transition-colors group-hover:text-atelier-tan"
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-[1px] h-12 bg-atelier-ink/20 group-hover:bg-atelier-tan transition-colors relative">
              <motion.div
                className="absolute top-0 left-0 w-full bg-mining-gold"
                initial={{ height: 0 }}
                animate={{ height: "100%" }}
            ...
            {/* Refined Arrow */}
            <motion.div
              className="mt-2 text-mining-gold group-hover:text-atelier-tan transition-colors"
              whileHover={{ y: -5 }}
            >
